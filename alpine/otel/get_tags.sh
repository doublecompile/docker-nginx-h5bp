...
echo "type=raw,value=$nginx_full_version-alpine$alpine_minor_version-otel"
echo "type=raw,value=$nginx_minor_version-alpine$alpine_minor_version-otel"
echo "type=raw,value=$nginx_branch-$variant"
echo "type=raw,value=$nginx_branch-alpine$alpine_minor_version-otel"
if [ "$nginx_branch" = "mainline" ]; then
  echo "type=raw,value=$nginx_major_version-$variant"
  echo "type=raw,value=$nginx_major_version-alpine$alpine_minor_version-otel"
  echo "type=raw,value=alpine$alpine_minor_version-otel"
